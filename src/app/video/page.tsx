  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-16 md:py-24">
      <div className="mb-16 border-b-4 border-black pb-4">
        ...
        <p className="text-gray-400 text-[10px] tracking-[0.3em] mt-2 uppercase">Official Archives</p>
      </div>
        ...
        {videos.map((video) => (
          <div key={video.id} className="group">
            ...
            <div className="mt-6 flex justify-between items-center">
              <h2 className="text-sm font-black tracking-widest uppercase text-gray-900 group-hover:text-red-600 transition-colors">
                {video.title}
              </h2>
            </div>
          </div>
